...
$sql_1 = "SELECT *, p.id AS property_id, p.name AS property_name, l.name AS location_name 
            FROM properties p
...
$sql_5 = "SELECT   payment_id, user_id ,property_id
FROM 
booked_users_properties bsp
INNER JOIN payments pay ON bsp.payment_id = pay.id
WHERE bsp.property_id = $property_id";
...
$booked_users = mysqli_fetch_all($result_5, MYSQLI_ASSOC);
$booked_users_count = mysqli_num_rows($result_5);
...
<head>
  ...
  <title>
    <?= $property['property_name']; ?>| PG Life
  </title>
...
<body>
  ...
  <nav aria-label="breadcrumb">
    <ol class="breadcrumb py-2">
      ...
      <li class="breadcrumb-item">
        <a href="property_list.php?location=<?= $property['location_name']; ?>"><?= $property['location_name']; ?></a>
      </li>
  ...
  <div id="property-images" class="carousel slide" data-ride="carousel">
    ...
    <div class="carousel-inner">
      ...
      foreach ($property_images as $index => $property_image) {
        ...
        <div class="carousel-item <?= $index == 0 ? "active" : ""; ?>">
          <img class="d-block w-75" src="<?= $property_image ?>" alt="slide" />
        </div>
        <?php
      }
      ?>
    ...
    <a href="#property-images" class="carousel-control-prev" role="button" data-slide="prev">
      <span class="carousel-control-prev-icon" aria-hidden="true"></span>
      <span class="sr-only">Previous</span>
    </a>
    <a href="#property-images" class="carousel-control-next" role="button" data-slide="next">
  ...
  <div class="property-summary page-container">
    ...
    <div class="row no-gutters">
      ...
      <?php
        $is_booked = false;
        foreach ($booked_users as $booked_user) {
          if ($booked_user['user_id'] == $user_id) {
            $is_booked = true;
          }
        }
        if ($is_booked) {
  ...
  <div class="property-testimonals page-container">
    <h1>What people say</h1>
    <?php
    foreach ($testimonials as $testimonial) {
      ?>
      <div class="testimonal-block">
        <div class="testimonal-image-container">
