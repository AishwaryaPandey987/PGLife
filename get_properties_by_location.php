...
$sql_1 = "SELECT * FROM locations WHERE name = '$location_name'";
$result_1 = mysqli_query($conn, $sql_1);
if (!$result_1) {
    echo "Something went wrong!";
    return;
}
$location = mysqli_fetch_assoc($result_1);
if (!$location) {
    echo "Sorry! We do not have any PG listed in this location.";
    return;
}
$location_id = $location['id'];

$sql_2 = "SELECT * FROM properties WHERE location_id = $location_id";
